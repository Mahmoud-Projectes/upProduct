...
@section('content')
    <div class="container">
        ...
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 app-btn-mb">
            <a class="btn btn-info btn-block" href="{{ route('statistics.downloadFileDay') }}"><img src="{{asset('images/icons/pdf-icon.svg')}}" width="16px"/><span class="pr-1">تحميل ملف الإنتاج اليومي</span></a>
        </div>
            @if(request()->user()['grants'] == 'admin')
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 app-btn-mb">
            <a class="btn btn-info btn-block" href="{{ route('statistics.downloadFileMonth') }}"><img src="{{asset('images/icons/pdf-icon.svg')}}" width="16px"/><span class="pr-1">تحميل ملف أخر انتاج  في هذا الشهر</span></a>
        </div>
